...
const createSendToken = (user, statusCode, res) => {
  ...
  const cookieOptions = {
    ...
    // // only sent on encrypted connection
    // secure: true,
    // cannot be modified by browser
    httpOnly: true
  };
  // cookie is a small piece of text that a server csn send to client
  // client receives cookie, automatically stores it and sends it back with all future
...
exports.resetPassword = catchAsync(async (req, res, next) => {
  ...
  // 3) Update chamgedPasswordAt property for the user
